...
// ---------- Main ----------
// Decision agent flow: Senso (understanding/impact) → Reka (plan) → Reka (validate).
app.post("/run-agent", async (req, res) => {
  ...
  // 1) Senso: impact assessment, labels, recommended_focus
  let senso;
  try {
...
app.listen(process.env.PORT || 8080, () => console.log("Decision agent (Senso+Reka) running"));
